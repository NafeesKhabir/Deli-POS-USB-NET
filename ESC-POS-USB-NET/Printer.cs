...
using Deli_POS_USB_NET.EpsonCommands;
using Deli_POS_USB_NET.Extensions;
using Deli_POS_USB_NET.Helper;
using Deli_POS_USB_NET.Interfaces.Command;
using Deli_POS_USB_NET.Interfaces.Printer;
using System;
using System.Collections.Generic;
using System.Drawing;
using System.Text;

namespace Deli_POS_USB_NET.Printer
{
    public class Printer : IPrinter
    {
        ...
        public Printer(string printerName, string codepage= "utf-8")
        {
